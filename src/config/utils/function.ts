...
export function normalizeCarDto(dto: CreateCarDto): CreateCarDto {
    ...
    return {
      ...
      discountValue: dto.discountValue ? convertToFloat(dto.discountValue.toString()) : undefined,
      rentalPriceDiscounted: dto.rentalPriceDiscounted ? convertToFloat(dto.rentalPriceDiscounted.toString()) : undefined,
